...
# frame = Frame(tkinter, borderwidth=2)
# frame.pack(fill=BOTH, expand=1)
label = tkinter.Label(root, text="Button Example")
# label.pack(fill=X, expand=1)

canvas = tkinter.Canvas(root, height=800, width=800, bg='white') #creates a canvas widget, which can be used for drawing lines and shapes
create_grid(canvas)
